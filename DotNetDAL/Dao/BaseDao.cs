    ...
    public class BaseDao
    {
        ...
        private Object Insert<T>(T obj, IDictionary hints, Boolean isCompositeKey) where T : class, new()
        {
            try
            {
                ...
                {
                    var statements = ShardingUtil
                        .GetShardStatementByEntity(LogicDbName, ShardingStrategy, new List<T> { obj }, table, hints,
        ...
        {
            var statements = ShardingUtil
                .GetShardStatement(LogicDbName, ShardingStrategy, parameters, hints,
